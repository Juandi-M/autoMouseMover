...
class StateManager:
    ...
    def can_transition_to(self, new_state: AppState) -> bool:
        ...
        valid_transitions = {
            AppState.STOPPED: [AppState.RUNNING, AppState.MINIMIZED, AppState.SHUTTING_DOWN],
            AppState.RUNNING: [AppState.STOPPED, AppState.MINIMIZED, AppState.SLEEPING, AppState.SHUTTING_DOWN],
            AppState.MINIMIZED: [AppState.RUNNING, AppState.STOPPED, AppState.SLEEPING, AppState.SHUTTING_DOWN],
