...
class SystemEventHandler(NSObject):
    def init(self):
        ...
        nc.addObserver_selector_name_object_(
            self, self.willSleep_, NSWorkspaceWillSleepNotification, None
        )

        nc.addObserver_selector_name_object_(
            self, self.didWake_, NSWorkspaceDidWakeNotification, None
        )
...
class AppEventHandler:
    ...
    def setup_handlers(self):
        self.system_handler.set_callbacks(self.handle_sleep, self.handle_wake)
